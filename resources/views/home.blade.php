            ...
            <form method="GET" action="{{ url('/') }}" class="flex flex-col md:flex-row gap-2 md:gap-3">
              ...
              <div class="flex gap-2">
                <select name="district" class="flex-1 md:flex-none md:w-40 text-xs bg-white/90 border border-white/60 rounded-xl px-3 py-2.5 text-slate-700">
                  ...
                  <option value="Banjarnegara" @if(request('district') === 'Banjarnegara') selected @endif>Banjarnegara</option>
                  <option value="Batur" @if(request('district') === 'Batur') selected @endif>Batur</option>
                </select>
                <button
                  type="submit"
