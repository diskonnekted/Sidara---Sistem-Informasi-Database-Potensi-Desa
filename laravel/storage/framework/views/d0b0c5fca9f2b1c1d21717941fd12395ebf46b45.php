...
<head>
  ...
  <link rel="manifest" href="<?php echo e(asset('manifest.json')); ?>?v=<?php echo e(time()); ?>">
  <link rel="apple-touch-icon" href="<?php echo e(asset('logo.jpg')); ?>?v=<?php echo e(time()); ?>">
  <link rel="icon" href="<?php echo e(asset('logo.jpg')); ?>?v=<?php echo e(time()); ?>" type="image/jpeg">
    ...
    <header class="relative z-0 w-full overflow-x-hidden">
      ...
      <div class="relative z-30 max-w-6xl mx-auto px-4 pt-4 pb-24 md:pb-32">
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(route('login')); ?>" class="hidden sm:inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur">
        ...
        <div class="mt-6 md:mt-8 max-w-2xl space-y-3">
          <div class="bg-white/10 backdrop-blur rounded-2xl p-2 border border-white/15">
            <form method="GET" action="<?php echo e(url('/')); ?>" class="flex flex-col gap-3">
                  ...
                  <select name="district" class="w-full text-xs bg-white/90 border border-white/60 rounded-xl px-3 py-2.5 text-slate-700 max-w-full">
                    ...
                    <?php if(isset($districts)): ?>
                      <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($district); ?>" <?php if(request('district') === $district): ?> selected <?php endif; ?>>
                          <?php echo e($district); ?>
                  ...
                  <select name="village" class="w-full text-xs bg-white/90 border border-white/60 rounded-xl px-3 py-2.5 text-slate-700 max-w-full">
                    ...
                    <?php if(isset($villages)): ?>
                      <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($village->id); ?>" <?php if((string)request('village') === (string)$village->id): ?> selected <?php endif; ?>>
        ...
        <div class="flex flex-col md:grid md:grid-cols-[2fr,1fr] gap-6 md:gap-8 items-start w-full">
          <section class="bg-white rounded-3xl shadow-lg shadow-amber-900/5 border border-amber-100 p-4 md:p-6 space-y-6 md:space-y-7">
            <div>
              <div class="flex items-center justify-between mb-4 md:mb-5">
                ...
                <span class="hidden md:inline-flex text-[11px] font-medium text-slate-400">
                  <?php echo e($latestPotentials->count()); ?> potensi
                </span>
              </div>
                ...
                <article class="bg-slate-50 rounded-2xl overflow-hidden border border-slate-100 flex flex-col max-w-full w-full">
                  ...
                  <div class="p-3.5 md:p-4 flex-1 flex flex-col gap-2">
                    ...
                    <div class="mt-auto pt-2">
                        <a href="<?php echo e(route('potentials.show', $potential->slug)); ?>" class="block w-full text-center bg-slate-200 text-slate-800 text-xs py-2 rounded-lg hover:bg-slate-300 transition-colors font-semibold">
                          Lihat Detail
                        </a>
                      </div>
                  </div>
            ...
            <div class="border-t border-slate-100 pt-4 md:pt-5">
              <div class="flex items-center justify-between mb-4 md:mb-5">
                ...
                <span class="hidden md:inline-flex text-[11px] font-medium text-slate-400">
                  <?php echo e($popularPotentials->count()); ?> potensi
                </span>
              </div>

              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 overflow-x-hidden">
                <?php $__empty_1 = true; $__currentLoopData = $popularPotentials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $potential): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php
                    $firstImage = $potential->images[0] ?? null;
                    if ($firstImage) {
                        if (preg_match('/^https?:\/\//i', $firstImage)) {
              ...
              <?php if($popularPotentials->hasPages()): ?>
                <div class="mt-4 md:mt-5">
                  <?php echo e($popularPotentials->onEachSide(1)->links()); ?>
          ...
          <aside class="order-2 space-y-4 md:space-y-5">
            <div class="bg-emerald-900 text-emerald-50 rounded-3xl p-4 md:p-5 flex flex-col gap-3 shadow-lg shadow-emerald-900/30">
              ...
              <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center justify-center gap-2 text-xs font-semibold bg-emerald-500 hover:bg-emerald-400 text-emerald-950 rounded-xl px-3 py-2">
            ...
            <div class="bg-[#f5f2ec] rounded-3xl border border-amber-100/70 p-4 md:p-5 space-y-3">
              <div class="flex items-center justify-between">
                ...
                <?php if(!empty($selectedCategory)): ?>
                  <span class="text-[11px] text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
                    Filter: <?php echo e(ucfirst($selectedCategory)); ?>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <a href="<?php echo e(url('/?category=umkm')); ?>" class="group flex items-start gap-2 rounded-2xl bg-white/90 border border-emerald-50 px-3 py-2.5 hover:border-emerald-300 hover:bg-emerald-50/60 transition">
                ...
                <a href="<?php echo e(url('/?category=wisata')); ?>" class="group flex items-start gap-2 rounded-2xl bg-white/90 border border-emerald-50 px-3 py-2.5 hover:border-emerald-300 hover:bg-emerald-50/60 transition">
                ...
                <a href="<?php echo e(url('/?category=pertanian')); ?>" class="group flex items-start gap-2 rounded-2xl bg-white/90 border border-emerald-50 px-3 py-2.5 hover:border-emerald-300 hover:bg-emerald-50/60 transition">
                ...
                <a href="<?php echo e(url('/?category=jasa')); ?>" class="group flex items-start gap-2 rounded-2xl bg-white/90 border border-emerald-50 px-3 py-2.5 hover:border-emerald-300 hover:bg-emerald-50/60 transition">
    ...
    <nav class="fixed bottom-0 inset-x-0 z-20 md:hidden">
      <div class="mx-auto max-w-md px-4 pb-3" style="padding-bottom: calc(0.75rem + env(safe-area-inset-bottom));">
        <div class="bg-white rounded-2xl shadow-xl border border-amber-100 px-4 py-1.5 flex justify-between">
          ...
          <a href="<?php echo e(route('products.index')); ?>" class="flex flex-col items-center justify-center flex-1 py-1.5 text-slate-500">
            <svg class="w-5 h-5 mb-0.5" viewBox="0 0 24 24" fill="none">
          ...
          <a href="<?php echo e(route('login')); ?>" class="flex flex-col items-center justify-center flex-1 py-1.5 text-slate-500">
            <svg class="w-5 h-5 mb-0.5" viewBox="0 0 24 24" fill="none">
